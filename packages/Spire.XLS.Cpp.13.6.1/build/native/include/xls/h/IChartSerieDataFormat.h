...
//#include "BaseFormatType.h"
//#include "ChartMarkerType.h"
//#include "ExcelColors.h"
//#include "TopFormatType.h"
...
*/
class EXPORTS IChartSerieDataFormat : public virtual IChartFillBorder
{
...
public:
    ...
    */
    virtual intrusive_ptr<IChartInterior> GetAreaProperties ()=0;
    /*
    <summary>
    ...
    */
    virtual BaseFormatType GetBarType ()=0;
    virtual void SetBarType (BaseFormatType value)=0;
    /*
    <summary>
    ...
    */
    virtual TopFormatType GetBarTopType ()=0;
    virtual void SetBarTopType (TopFormatType value)=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<Color> GetMarkerBackgroundColor ()=0;
    virtual void SetMarkerBackgroundColor (intrusive_ptr<Color> value)=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<Color> GetMarkerForegroundColor ()=0;
    virtual void SetMarkerForegroundColor (intrusive_ptr<Color> value)=0;
    /*
    <summary>
        Type of marker.
    ...
    */
    virtual ChartMarkerType GetMarkerStyle ()=0;
    virtual void SetMarkerStyle (ChartMarkerType value)=0;
    /*
    <summary>
    ...
    */
    virtual ExcelColors GetMarkerForegroundKnownColor ()=0;
    virtual void SetMarkerForegroundKnownColor (ExcelColors value)=0;
    /*
    <summary>
    ...
    */
    virtual ExcelColors GetMarkerBackgroundKnownColor ()=0;
    virtual void SetMarkerBackgroundKnownColor (ExcelColors value)=0;
    /*
    <summary>
    ...
    */
    ...
    virtual void SetMarkerSize (int value)=0;
    /*
    <summary>
        Automatic color.
    ...
    */
    virtual bool GetIsAutoMarker ()=0;
    virtual void SetIsAutoMarker (bool value)=0;
    /*
    <summary>
    ...
    */
    ...
    virtual void SetPercent (int value)=0;
    /*
    <summary>
    ...
    */
    virtual bool GetIs3DBubbles ()=0;
    virtual void SetIs3DBubbles (bool value)=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<IChartFormat> GetOptions ()=0;
    /*
    <summary>
    ...
    */
    virtual bool GetIsMarkerSupported ()=0;
private:
};
}}
