...
//#include "ConditionalFormats.h"
#pragma warning(pop)

namespace Spire{
namespace Xls{
class EXPORTS IXLSRange : public virtual IExcelApplication
{
    friend class ExcelCommentObject;
    friend class Workbook;
    friend class ChartSerie;
    friend class IXLSRanges;
    friend class IPivotCache;
    friend class IChart;
    friend class IChartCategoryAxis;
    friend class IChartErrorBars;
    friend class IChartSerie;
    friend class IComboBoxShape;
    friend class IListBox;
    friend class IOleObject;
    friend class IShape;
    friend class ISortedRule;
    friend class ICombinedRange;
    friend class IDataValidation;
    friend class IHyperLink;
    ...
    friend class XlsHyperLink;
    friend class XlsName;
    friend class XlsRange;
    friend class CellValueChangedEventArgs;
    friend class XlsValidationWrapper;
...
public:
    //virtual System.Object GetValue2 ()=0;
    //virtual void SetValue2 (System.Object value)=0;
    /*
    <summary>
    ...
    */
    ...
    virtual void SetItem (int row,int column,intrusive_ptr<IXLSRange> value)=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<IXLSRange> Get (LPCWSTR_S name,bool IsR1C1Notation)=0;
    /*
    <summary>
        Collection of conditional formats.
    </summary>
    */
    virtual intrusive_ptr<ConditionalFormats> GetConditionalFormats ()=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<Validation> GetDataValidation ()=0;
    /*
    <summary>
        Gets / sets string value evaluated by formula.
    </summary>
    */
    virtual LPCWSTR_S GetFormulaStringValue ()=0;
    virtual void SetFormulaStringValue (LPCWSTR_S value)=0;
    /*
    <summary>
         Gets / sets number value evaluated by formula.
     </summary>
    */
    virtual double GetFormulaNumberValue ()=0;
    virtual void SetFormulaNumberValue (double value)=0;
    /*
    <summary>
        Indicates if current range has formula bool value. Read only.
    </summary>
    */
    virtual bool GetHasFormulaBoolValue ()=0;
    /*
    <summary>
        Indicates if current range has formula error value. Read only.
    </summary>
    */
    virtual bool GetHasFormulaErrorValue ()=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<IComment> GetComment ()=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<IXLSRange> GetMergeArea ()=0;
    /*
    <summary>
    ...
    */
    virtual bool GetHasExternalFormula ()=0;
    /*
    <summary>
        Represents ignore error options.
    </summary>
    */
    virtual IgnoreErrorType GetIgnoreErrorOptions ()=0;
    virtual void SetIgnoreErrorOptions (IgnoreErrorType value)=0;
    //virtual System.Nullable`1[[System.Boolean, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]] GetIsStringsPreserved ()=0;
    //virtual void SetIsStringsPreserved (System.Nullable`1[[System.Boolean, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]] value)=0;
    //virtual System.Nullable`1[[Spire.Xls.BuiltInStyles, Spire.XLS, Version=12.7.7.0, Culture=neutral, PublicKeyToken=null]] GetBuiltInStyle ()=0;
    //virtual void SetBuiltInStyle (System.Nullable`1[[Spire.Xls.BuiltInStyles, Spire.XLS, Version=12.7.7.0, Culture=neutral, PublicKeyToken=null]] value)=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<IXLSRange> Activate (bool scroll)=0;
    /*
    <summary>
    ...
    */
    virtual void Merge (bool clearCells)=0;
    /*
    <summary>
    ...
    */
    virtual void Clear (ExcelClearOptions option)=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<IXLSRange> Intersect (intrusive_ptr<IXLSRange> range)=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<IXLSRange> Merge (intrusive_ptr<IXLSRange> range)=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<ICommentShape> AddComment ()=0;
    /*
    <summary>
    ...
    */
    virtual void BorderAround (LineStyleType borderLine)=0;
    /*
    <summary>
         Sets around border for current range.
    ...
    */
    virtual void BorderAround (LineStyleType borderLine,intrusive_ptr<Color> borderColor)=0;
    /*
    <summary>
         Sets around border for current range.
    ...
    */
    virtual void BorderAround (LineStyleType borderLine,ExcelColors borderColor)=0;
    /*
    <summary>
    ...
    */
    ...
    <param name="borderLine">Represents border line.</param>
    */
    virtual void BorderInside (LineStyleType borderLine)=0;
    //virtual void BorderInside (LineStyleType borderLine,intrusive_ptr<Color> borderColor)=0;
    /*
    <summary>
         Sets inside border for current range.
    ...
    <param name="borderColor">Represents border color as ExcelColors.</param>
    */
    virtual void BorderInside (LineStyleType borderLine,ExcelColors borderColor)=0;
    /*
    <summary>
    ...
    */
    virtual void CollapseGroup (GroupByType groupBy)=0;
    /*
    <summary>
    ...
    */
    virtual void ExpandGroup (GroupByType groupBy)=0;
    /*
    <summary>
         Expands current group.
    ...
    */
    virtual void ExpandGroup (GroupByType groupBy,ExpandCollapseFlags flags)=0;
    //virtual System.Data.DataTable ExportDataTable (intrusive_ptr<ExportTableOptions> options)=0;
    /*
    <summary>
    ...
    */
    virtual LPCWSTR_S GetRangeAddress ()=0;
    /*
    <summary>
    ...
    */
    virtual LPCWSTR_S GetRangeAddressLocal ()=0;
    /*
    <summary>
    ...
    */
    virtual LPCWSTR_S GetRangeGlobalAddress ()=0;
    /*
    <summary>
    ...
    */
    virtual LPCWSTR_S GetRangeR1C1Address ()=0;
    /*
    <summary>
         Returns the range reference using R1C1 notation.
             Read-only String.
    ...
    */
    virtual LPCWSTR_S GetRangeR1C1AddressLocal ()=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<IList<CellRange>> GetCells ()=0;
    //virtual System.Collections.Generic.List`1[[Spire.Xls.CellRange, Spire.XLS, Version=12.7.7.0, Culture=neutral, PublicKeyToken=null]] GetCellList ()=0;
    /*
    <summary>
    ...
    */
    virtual int GetColumnGroupLevel ()=0;
    /*
    <summary>
    ...
    */
    virtual double GetColumnWidth ()=0;
    virtual void SetColumnWidth (double value)=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<DateTime> GetDateTimeValue ()=0;
    virtual void SetDateTimeValue (intrusive_ptr<DateTime> value)=0;
    /*
    <summary>
    ...
    */
    virtual LPCWSTR_S GetNumberText ()=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<IXLSRange> GetEndCell ()=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<IXLSRange> GetEntireColumn ()=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<IXLSRange> GetEntireRow ()=0;
    /*
    <summary>
        Gets / sets error value that is contained by this range.
    </summary>
    */
    virtual LPCWSTR_S GetErrorValue ()=0;
    virtual void SetErrorValue (LPCWSTR_S value)=0;
    /*
    <summary>
    ...
    */
    virtual LPCWSTR_S GetFormulaArray ()=0;
    virtual void SetFormulaArray (LPCWSTR_S value)=0;
    /*
    <summary>
        Returns or sets the formula array for the range, using R1C1-style notation.
    </summary>
    */
    virtual LPCWSTR_S GetFormulaArrayR1C1 ()=0;
    virtual void SetFormulaArrayR1C1 (LPCWSTR_S value)=0;
    /*
    <summary>
    ...
    */
    virtual bool GetIsFormulaHidden ()=0;
    ...
    */
    virtual intrusive_ptr<DateTime> GetFormulaDateTime ()=0;
    virtual void SetFormulaDateTime (intrusive_ptr<DateTime> value)=0;
    /*
    <summary>
        Returns or sets the formula for the range, using R1C1-style notation.
    </summary>
    */
    virtual LPCWSTR_S GetFormulaR1C1 ()=0;
    virtual void SetFormulaR1C1 (LPCWSTR_S value)=0;
    /*
    <summary>
        Returns the calculated value of the formula as a boolean.
    </summary>
    */
    virtual bool GetFormulaBoolValue ()=0;
    virtual void SetFormulaBoolValue (bool value)=0;
    /*
    <summary>
        Returns the calculated value of the formula as a string.
    </summary>
    */
    virtual LPCWSTR_S GetFormulaErrorValue ()=0;
    virtual void SetFormulaErrorValue (LPCWSTR_S value)=0;
    /*
    <summary>
    ...
    */
    virtual bool GetHasDataValidation ()=0;
    /*
    <summary>
    ...
    */
    virtual bool GetHasRichText ()=0;
    /*
    <summary>
        Indicates whether the range contains String. Read-only.
    </summary>
    */
    virtual bool GetHasString ()=0;
    /*
    <summary>
    ...
    */
    virtual bool GetIsGroupedByColumn ()=0;
    /*
    <summary>
        Indicates whether this range is grouped by row. Read-only.
    </summary>
    */
    virtual bool GetIsGroupedByRow ()=0;
    /*
    <summary>
    ...
    */
    virtual int GetRowGroupLevel ()=0;
    /*
    <summary>
    ...
    */
    virtual double GetRowHeight ()=0;
    virtual void SetRowHeight (double value)=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<IStyle> GetStyle ()=0;
    virtual void SetStyle (intrusive_ptr<IStyle> value)=0;
    /*
    <summary>
    ...
    */
    virtual LPCWSTR_S GetCellStyleName ()=0;
    virtual void SetCellStyleName (LPCWSTR_S value)=0;
    /*
    <summary>
    ...
    */
    virtual intrusive_ptr<TimeSpan> GetTimeSpanValue ()=0;
    virtual void SetTimeSpanValue (intrusive_ptr<TimeSpan> value)=0;
    /*
    <summary>
    ...
    */
    virtual LPCWSTR_S GetEnvalutedValue ()=0;
private:
};
}}
